...
try {
  execSync('node ../dist/cli.js extract --lang es --src ./src --out ./demo-locales', { 
    stdio: 'inherit',
    cwd: process.cwd()
  })
...
const spanishTranslations = `Welcome to our store, \${1}!: '¡Bienvenido a nuestra tienda, \${1}!'
You have \${1} items in your cart.: 'Tienes \${1} artículos en tu carrito.'
